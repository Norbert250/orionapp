          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-gray-600">Manage your active loan payments</p>
              </div>
              <button
                onClick={() => navigate('/')}
                className="bg-white text-gray-700 px-6 py-3 rounded-lg font-medium shadow-sm hover:shadow-md transition-shadow flex items-center border border-gray-200"
              >
                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                          <div className="text-sm font-medium text-gray-700 mb-1">Loan Amount</div>
                          <div className="text-xl font-semibold text-gray-900">{formatCurrency(loan.amount_requested)}</div>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                          ...
                          <div className="text-lg font-semibold text-gray-900">{formatDate(loan.repayment_date)}</div>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                          <div className="text-sm font-medium text-gray-700 mb-1">Applied</div>
                          <div className="text-lg font-semibold text-gray-900">{formatDate(loan.created_at)}</div>
                        </div>
                      </div>
                  </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <button
                        ...
                        className="px-6 py-3 rounded-lg font-medium text-white shadow-sm hover:shadow-md transition-shadow flex items-center justify-center bg-green-600 hover:bg-green-700"
                      >
